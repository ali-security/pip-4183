...
def _wrapper(args: list[str] | None = None) -> int:
    ...
    of them having a pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'ed, users suffer every time an entrypoint gets
    moved.
