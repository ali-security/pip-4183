...
def _get_simple_response(url: str, session: PipSession) -> Response:
    ...
    resp = session.get(
        ...
        headers={
            ...
            # twine upload && pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' will function, but if
            # they've done a pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' in the last ~10 minutes
