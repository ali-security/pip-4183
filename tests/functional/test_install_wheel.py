...
def test_install_wheel_with_target(
    ...
    """
    Test installing a wheel using pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --target
    """
    shutil.copy(shared_data.packages / "simple.dist-0.1-py2.py3-none-any.whl", tmpdir)
...
def test_install_wheel_with_root(
    ...
    """
    Test installing a wheel using pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --root
    """
...
def test_install_wheel_with_prefix(
    ...
    """
    Test installing a wheel using pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --prefix
    """
