...
- Add ``--use-feature inprocess-build-deps`` to request that build dependencies are installed
  within the same pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' process. This new mechanism is faster, supports ``--no-clean``
...
- When :pep:`658` metadata is available, full distribution files are no longer downloaded when using ``pip lock`` or ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --dry-run``. (`#12603 <https://github.com/pypa/pip/issues/12603>`_)
...
- Building pip itself from source now uses flit-core instead of setuptools.
  This does not affect how pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'s or builds packages you use. (`#13473 <https://github.com/pypa/pip/issues/13473>`_)
...
- Support :pep:`639` ``License-Expression`` and ``License-File`` metadata fields in JSON
  output. ``pip inspect`` and ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --report`` now emit
...
- Deprecate ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --editable`` falling back to ``setup.py develop``
...
- Improve pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' performance.
...
- Improve pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' performance by only creating required parent
  directories once, instead of before extracting every file in the wheel. (`#12782 <https://github.com/pypa/pip/issues/12782>`_)
- Improve pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' performance by calculating installed packages printout
...
- Ensure ``-vv`` gets passed to any ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` build environment subprocesses. (`#12577 <https://github.com/pypa/pip/issues/12577>`_)
...
- Fix outdated pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' argument description in documentation. (`#12417 <https://github.com/pypa/pip/issues/12417>`_)
...
- Allow ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --dry-run`` to use platform and ABI overriding options. (`#12215 <https://github.com/pypa/pip/issues/12215>`_)
...
- Present conflict information during installation after each choice that is rejected (pass ``-vv`` to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` to show it) (`#10937 <https://github.com/pypa/pip/issues/10937>`_)
...
- Quote extras in the pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' docs to guard shells with default glob
...
- Fix an issue when an already existing in-memory distribution would cause
  exceptions in ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` (`#11704 <https://github.com/pypa/pip/issues/11704>`_)
...
- Add ``--dry-run`` option to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``, to let it print what it would install but
...
- Fix ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --pre`` for packages with pre-release build dependencies defined
...
- Fix pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' issues using a proxy due to an inconsistency in how Requests is currently handling variable precedence in session. (`#9691 <https://github.com/pypa/pip/issues/9691>`_)
...
- Documents the ``--require-virtualenv`` flag for ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. (`#10588 <https://github.com/pypa/pip/issues/10588>`_)
- ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' <tab>`` autocompletes paths. (`#10646 <https://github.com/pypa/pip/issues/10646>`_)
...
- ``pip freeze``, ``pip list``, and ``pip show`` no longer normalize underscore
  ...
  into ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``) since pip internally performs standard PEP 503
...
- When pip is asked to uninstall a project without the dist-info/RECORD file
  ...
  but it will provide a better error message instead, such as::
      ...
      ERROR: Cannot uninstall foobar 0.1, RECORD file not found. You might be able to recover from this via: 'pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --force-reinstall --no-deps foobar==0.1'.
...
- Improve performance when picking the best file from indexes during ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. (`#9748 <https://github.com/pypa/pip/issues/9748>`_)
...
- Only query the keyring for URLs that actually trigger error 401.
  This prevents an unnecessary keyring unlock prompt on every pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'
...
- ``pip wheel`` now verifies the built wheel contains valid metadata, and can be
  installed by a subsequent ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. This can be disabled with
...
- Log debugging information about pip, in ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --verbose``. (`#3166 <https://github.com/pypa/pip/issues/3166>`_)
...
- Raise error if ``--user`` and ``--target`` are used together in ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` (`#7249 <https://github.com/pypa/pip/issues/7249>`_)
...
- Warn if a path in PATH starts with tilde during ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. (`#6414 <https://github.com/pypa/pip/issues/6414>`_)
...
- Cache wheels that ``pip wheel`` built locally, matching what
  ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` does. This particularly helps performance in workflows where
...
- Fix ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` to respect ``--ignore-requires-python`` when evaluating
...
- Prevent ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' <url>`` from permitting directory traversal if e.g.
...
- Replace a failing example of pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'s with extras with a working one. (`#4733 <https://github.com/pypa/pip/issues/4733>`_)
...
- Canonicalize sdist file names so they can be matched to a canonicalized package name passed to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. (`#5870 <https://github.com/pypa/pip/issues/5870>`_)
...
- Support passing ``svn+ssh`` URLs with a username to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -e``. (`#5375 <https://github.com/pypa/pip/issues/5375>`_)
...
- Do not warn about script location when installing to the directory containing
  sys.executable. This is the case when 'pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/''ing without activating a
  virtualenv. (#5157)
...
- Removed the deprecated ``--egg`` parameter to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. (#1749)
...
- Removed the deprecated ``--download`` option to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. (#2643)
- Removed the deprecated --(no-)use-wheel flags to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` and ``pip
  wheel``. (#2699)
...
- Add `--progress-bar <progress_bar>` to ``pip download``, ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` and
...
- Improve the error message for the common ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' ./requirements.txt``
  case. (#4127)
...
- pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' now prints an error message when it installs an incompatible
  version of a dependency. (#5000)
- Added a way to distinguish between pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'ed packages and those from the
...
- Make ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --force-reinstall`` not require passing ``--upgrade``.
  (#1139)
- Return a failing exit status when `pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`, `pip download`, or `pip
...
- Fixes destination directory of data_files when ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --target`` is
  used. (#4092)
...
- Fix an issue where ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -e`` on a Git url would fail to update if a
...
- **DEPRECATION** ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --egg`` have been deprecated and will be
...
- Add an ``--upgrade-strategy`` option to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``, to control how
...
- Implement a top-level ``pip download`` command and deprecate
  ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --download``.
...
- Fix a bug causing pip to not select a wheel compiled against an OSX SDK later
  ...
  of OSX.
- Add a new ``--prefix`` option for ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` that supports wheels and
  sdists. (#3252)
...
- Add the ``--prefix`` flag to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` which allows specifying a root
...
- Removed the temporary modifications (that began in pip v1.4 when distribute
  ...
  setuptools. ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -U setuptools`` will no longer upgrade "distribute"
  to "setuptools".  Instead, use ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -U distribute``. (#2767)
...
- Display much less output when `pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'` succeeds, because on success,
  users probably don't care about all the nitty gritty details of compiling and
  installing. When `pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'` fails, display the failed install output once
...
- **BACKWARD INCOMPATIBLE** PEP 440 is now fully implemented, this means that
  ...
  similarly to before.
- **DEPRECATION** ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --download-cache`` and
...
- **DEPRECATION** ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --build`` and ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-clean`` are now
...
- **DEPRECATION** Implicitly accessing URLs which point to an origin which is
  ...
  ``--trusted-host`` flag (``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --trusted-host example.com foo``).
...
- Added support to respect proxies in ``pip search``.
  (#1180, #932, #1104, #1902)
- `pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --download` works with vcs links. (#798, #1060, #1926)
...
- Correct deprecation warning for ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --build`` to only notify when
...
- ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --download`` was failing using local ``--find-links``.
  (#1111, #1524)
...
- **DEPRECATION** ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-install`` and ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'
...
- Fixed problem where re-installs always occurred when using file:// find-links.
  (#683, #702)
- "pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -v" now shows the full download url, not just the archive name.
...
- Added `--root` option for "pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'" to specify root directory. Behaves
...
- Prevent e.g. ``gmpy2-2.0.tar.gz`` from matching a request to
  ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' gmpy``; sdist filename must begin with full project name
...
- pip now supports optionally installing setuptools "extras" dependencies; e.g.
  "pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' Paste[openid]". Thanks Matt Maker and Olivier Girardot. (#7)
...
- pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -U no longer reinstalls the same versions of packages. Thanks
...
- Removed ``-E``/``--environment`` option and ``PIP_RESPECT_VIRTUALENV``;
  ...
  path/to/venv/pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' Foo``.
...
- Added ability to install version control requirements without making them
  editable, e.g.::
    ...
    pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' git+https://github.com/pypa/pip/
...
- Fixed installing directly from directories (e.g.
  ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' path/to/dir/``).
...
- Fixed "pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' ." and "pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' .."; better error for directory
...
- Allow packages to be upgraded, e.g., ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' Package==0.1``
  then ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' Package==0.2``.
...
- Extended integration with virtualenv by providing an option to
  ...
  virtualenv is found.
- Fixed a bug with pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --download and editable packages, where
...
- Renamed to ``pip``, and to install you now do ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'
  PACKAGE``
