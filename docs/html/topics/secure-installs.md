...
```{pip-cli}
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-deps .
```

Instead of `python setup.py develop`, use:

```{pip-cli}
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-deps -e .
```
