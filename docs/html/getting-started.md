...
```{pip-cli}
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' sampleproject
[...]
...
```{pip-cli}
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' git+https://github.com/pypa/sampleproject.git@main
[...]
Successfully installed sampleproject
```
...
```{pip-cli}
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' sampleproject-1.0.tar.gz
[...]
Successfully installed sampleproject
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' sampleproject-1.0-py3-none-any.whl
[...]
Successfully installed sampleproject
```
...
```{pip-cli}
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -r requirements.txt
[...]
Successfully installed sampleproject
```
...
```{pip-cli}
$ pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --upgrade sampleproject
   [...]
Successfully installed sampleproject
```
