...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage            # latest version
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage==1.0.4     # specific version
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' 'SomePackage>=1.0.4'     # minimum version

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage            # latest version
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage==1.0.4     # specific version
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' 'SomePackage>=1.0.4'   # minimum version

For more information and examples, see the :ref:`pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'` reference.
...
installed using :ref:`pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'` like so:

.. tab:: Unix/macOS

   .. code-block:: shell

      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -r requirements.txt

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -r requirements.txt

Details on the format of the files are here: :ref:`requirements-file-format`.

Logically, a Requirements file is just a list of :ref:`pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'` arguments
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -c constraints.txt

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -c constraints.txt
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --build-constraint build-constraints.txt SomePackage

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --build-constraint build-constraints.txt SomePackage
...
By default, pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'s stable versions of packages, unless their specifier includes
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --all-releases=DependencyPackage SomePackage
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --all-releases=:all: SomePackage

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --all-releases=DependencyPackage SomePackage
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --all-releases=:all: SomePackage
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --only-final=DependencyPackage SomePackage
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --only-final=:all: SomePackage

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --only-final=DependencyPackage SomePackage
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --only-final=:all: SomePackage
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --uploaded-prior-to=2025-03-16T00:00:00Z SomePackage
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --uploaded-prior-to=P3D SomePackage

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --uploaded-prior-to=2025-03-16T00:00:00Z SomePackage
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --uploaded-prior-to=P3D SomePackage
...
.. note::
    ...
    ``--uploaded-prior-to`` setting, e.g. ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' /path/to/package.whl``,
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -c constraints.txt --uploaded-prior-to=2025-03-16 SomePackage

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' -c constraints.txt --uploaded-prior-to=2025-03-16 SomePackage
...
groups cannot contain non-package arguments for :ref:`pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`.
...
and installed with :ref:`pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'` like so:

.. tab:: Unix/macOS

   .. code-block:: shell

      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --group groupA

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --group groupA
...
:ref:`pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'` can use a file from another directory. For example:

.. tab:: Unix/macOS

   .. code-block:: shell

      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --group './project/subproject/pyproject.toml:groupA'

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --group './project/subproject/pyproject.toml:groupA'
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --group './sub1/pyproject.toml:groupA' --group './sub2/pyproject.toml:groupB'

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --group './sub1/pyproject.toml:groupA' --group './sub2/pyproject.toml:groupB'
...
:ref:`--no-binary <install_--no-binary>` flag for :ref:`pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`.
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage-1.0-py2.py3-none-any.whl

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage-1.0-py2.py3-none-any.whl
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' './somepackage-1.0-py2.py3-none-any.whl[my-extras]'

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' './somepackage-1.0-py2.py3-none-any.whl[my-extras]'
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' wheel
...
.. tab:: Windows
   ...
   .. code-block:: shell
      ...
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' wheel
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-index --find-links=/local/wheels -r requirements.txt

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-index --find-links=/local/wheels -r requirements.txt
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-index --find-links=DIR -r requirements.txt

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --no-index --find-links=DIR -r requirements.txt


"Only if needed" Recursive Upgrade
==================================

``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --upgrade`` now has a ``--upgrade-strategy`` option which
...
- ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage``: will not upgrade the existing ``SomePackage`` or
  ``SomeDependency``.
- ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --upgrade SomePackage``: will upgrade ``SomePackage``, but not
  ``SomeDependency`` (unless a minimum requirement is not met).
- ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --upgrade SomePackage --upgrade-strategy=eager``: upgrades both
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --upgrade --no-deps SomePackage
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage

.. tab:: Windows

   .. code-block:: shell

      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --upgrade --no-deps SomePackage
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' SomePackage
...
<install_--user>` option to ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``.
...
.. tab:: Unix/macOS
   ...
   .. code-block:: shell
      ...
      python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user SomePackage
...
.. tab:: Windows
   ...
   .. code-block:: shell
      ...
      py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user SomePackage

``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user`` follows four rules:
...
.. tab:: Windows
   ...
   .. code-block:: console
      ...
      C:\> py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user SomePackage
      Can not perform a '--user' install. User site-packages are not visible in this virtualenv.
...
.. tab:: Unix/macOS
   ...
   .. code-block:: console
      ...
      $ python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user SomePackage==0.4
...
.. tab:: Windows
   ...
   .. code-block:: console
      ...
      C:\> py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user SomePackage==0.4
      Will not install to the user site because it will lack sys.path precedence
...
.. tab:: Unix/macOS
   ...
   .. code-block:: console
      ...
      $ python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user --upgrade SomePackage
      [...]
      Successfully installed SomePackage
...
.. tab:: Windows
   ...
   .. code-block:: console
      ...
      [...]
      Requirement already satisfied (use --upgrade to upgrade)
      C:\> py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user --upgrade SomePackage
      [...]
      Successfully installed SomePackage
...
.. tab:: Unix/macOS
   ...
   .. code-block:: console
      ...
      # force the install
      $ python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user --ignore-installed SomePackage
      [...]
      Successfully installed SomePackage
...
.. tab:: Windows
   ...
   .. code-block:: console
      ...
      Requirement already up-to-date: SomePackage
      # force the install
      C:\> py -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --user --ignore-installed SomePackage
      [...]
      Successfully installed SomePackage
...
* It will **reduce inconsistency**: it will *no longer install a
  ...
  package. For example, in pip 20.0, ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' "six<1.12"
...
This also means that, when you run a ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'`` command, pip only
...
environment will be consistent all the time. If you ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' x``
and then ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' y``, it's possible that the version of ``y``
...
1. **Install pip 20.3** with ``python -m pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --upgrade pip``.
...
3. **Test the new version of pip**.
   ...
   -  If you use pip to install your software, try out the new resolver
      and let us know if it works for you with ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'``. Try:

      - installing several packages simultaneously
      - re-creating an environment using a ``requirements.txt`` file
      - using ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' --force-reinstall`` to check whether
        it does what you think it should
      - using constraints files
      - the "Setups to test with special attention" and "Examples to try" below

   -  If you have a build pipeline that depends on pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/'ing your
...
* ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' flake8-import-order==0.17.1 flake8==3.5.0 --use-feature=2020-resolver``
* ``pip install --index-url 'https://:2026-04-26T21:00:03.194846Z@time-machines-pypi.sealsecurity.io/' tornado==5.0 sprockets.http==1.5.0 --use-feature=2020-resolver``
